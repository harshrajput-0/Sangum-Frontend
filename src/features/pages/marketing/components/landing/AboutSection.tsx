export default function AboutSection() {
  return (
    <section className="relative border-t-0 bg-[#0b0f14] py-16">
      <div className="relative z-[2] mx-auto max-w-[680px] px-6 text-center">
        <p className="mb-5 text-[17px] leading-[1.75] text-[#cbd5e1]">
        ...
        <p className="text-[17px] leading-[1.75] text-[#cbd5e1]">
