  ...
  return (
    <div>
      ...
      <form onSubmit={onSubmit} noValidate>
        ...
        {/*
          A 400 here covers invalid, expired, AND already-used tokens
          (single-use) — shown as one generic submit error since the
          backend's message already distinguishes them, and there's no
          separate "invalid route" state anymore now that the token
          comes from the dynamic segment.
        */}
        {submitError && (
