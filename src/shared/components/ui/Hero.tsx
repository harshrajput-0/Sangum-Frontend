    ...
    <section className="relative min-h-screen flex items-center bg-(--dbg) justify-center overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-12">
          ...
          <Button variant="doutline" size="lg" className="border(--dborder)">
        ...
        {!submitted ? (
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-(--dsurface) border border-brand-cyan/40 text-brand-cyan text-sm">
