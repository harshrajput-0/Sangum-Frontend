...
export const IconHome: IconComponent = (props) => (
  <LineIcon {...props}>
...
export const IconCompass: IconComponent = (props) => (
  <LineIcon {...props}>
...
/** Distinct glyph from IconMail — a closed rectangular speech bubble, used specifically for MobileBottomNav's "Chat" tab. */
...
export const AdminIconUsers: IconComponent = (props) => (
  <LineIcon {...props}>
...
export const Icons = {
  ...
  collapseSidebar: IconChevronLeft,
  expandSidebar: IconChevronRight,
  ...
  adminCommunities: AdminIconUsers,
