...
//       <EmptyBoxIcon className="w-10 h-10 text-text-muted" />
//       <p className="text-(length:--fs-sm) text-text-muted">{message}</p>
//     </div>
//   );
// }
...
//                 <div className="h-2.5 w-1/3 rounded-sm bg-(--surface-2) mb-2" />
...
//           (communitiesLoading ? (
//             Array.from({ length: 3 }).map((_, i) => (
//               <div key={i} className="rounded-lg border border-border bg-surface p-3.5 animate-pulse flex items-center gap-3">
//                 <div className="w-10 h-10 rounded-md bg-(--surface-2) shrink-0" />
//                 <div className="flex-1">
//                   <div className="h-2.5 w-1/3 rounded-sm bg-(--surface-2) mb-1.5" />
//                   <div className="h-2 w-1/4 rounded-sm bg-(--surface-2)" />
//                 </div>
//               </div>
//             ))
