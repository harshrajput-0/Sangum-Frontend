...
const AuthFormHeader = ({eyebrow, title, description}: AuthFormHeaderProps) => {
    return (
          <div className="max-w-2xl w-full mx-auto lg:mx-0">
            <span className="block text-[length:var(--fs-xs)] font-semibold tracking-widest uppercase text-[var(--brand-purple-light)] mb-2">
              {eyebrow}
            </span>
            <h1 className="text-[32px] font-extrabold text-[var(--text)] leading-tight mb-2.5">{title}</h1>
