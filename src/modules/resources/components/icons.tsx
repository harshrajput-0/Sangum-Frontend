// modules/resources/components/icons.tsx

/**
 * Placeholder icon set for the resources module — simple/generic outline
...
// ---- ResourceTypeBadge icons ------------------------------------------------

/** icon: document/article placeholder — replace later */
...
/** icon: graduation cap placeholder — replace later */
...
/** icon: open book placeholder — replace later */
...
/** icon: wrench/tool placeholder — replace later */
...
/** icon: paper/lined-doc placeholder — replace later */
...
export interface ToggleIconProps extends IconProps {
  /** Switches between filled (active/bookmarked) and outline rendering. */
  filled?: boolean;
}
...
/** icon: magnifier/search placeholder — replace later */
...
/** icon: chevron-down for select affordance placeholder — replace later */
